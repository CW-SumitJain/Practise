...
public class RecycleAdapter extends RecyclerView.Adapter<RecycleAdapter.HolderView>{
    Context mContext;
    String text;
    public int[] image_list= {R.drawable.car1,R.drawable.car2,R.drawable.car3,R.drawable.car4,R.drawable.index,R.drawable.a1,R.drawable.a2,R.drawable.a3,R.drawable.a4,R.drawable.a5,R.drawable.a6};
